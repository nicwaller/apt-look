...
func TestCacheTransport_FileDetection(t *testing.T) {
	tests := []struct {
		...
		{"http://example.com/dists/jammy/Release", true, false},
		{"http://example.com/dists/jammy/Release.gpg", true, false},
		{"http://example.com/dists/jammy/InRelease", true, false},
		{"http://example.com/dists/jammy/main/binary-amd64/Packages", false, true},
		{"http://example.com/dists/jammy/main/binary-amd64/Packages.gz", false, true},
		{"http://example.com/dists/jammy/main/binary-amd64/Packages.bz2", false, true},
		{"http://example.com/dists/jammy/main/binary-amd64/Packages.xz", false, true},
		{"http://example.com/some/other/file", false, false},
	}
